...
const ManagesTable = () => {
  ...
  return (
    <Container className="rounded mt-5 p-md-5" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', position: 'relative', marginLeft: '150px', padding: '20px' }}>
            ...
            {Array.isArray(users.doc) && users.doc.map((user) => (
              <TableRow key={user._id} className="bg-blue">
                <TableCell style={{ padding: '8px', textAlign: 'center' }}>
                  <img src={user.image} alt="" style={{ padding: '8px', alignItems: 'center', width: "60px", height: "60px", borderRadius: '50%' }} />
                </TableCell>
                <TableCell>
      ...
      {add && (
        <>
          ...
          <div className="row modal-container" style={{ position: 'absolute', bottom: '50%', left: '50%', transform: 'translate(-50%, -50%)', top: '25%' }}>
